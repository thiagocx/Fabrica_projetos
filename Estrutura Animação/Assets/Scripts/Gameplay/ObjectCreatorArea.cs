...
public class ObjectCreatorArea : MonoBehaviour
{
	...
	public float spawnMinInterval = 2;
	public float spawnMaxInterval = 5;
	...
	IEnumerator SpawnObject ()
	{
		while(true)
		{
			...
			yield return new WaitForSeconds(spawnMinInterval);
			yield return new WaitForSeconds(spawnMaxInterval);
